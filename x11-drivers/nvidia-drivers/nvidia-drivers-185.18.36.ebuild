# Copyright 1999-2009 Gentoo Foundation; 2008-2009 Chris Gianelloni
...
src_install() {
	...
	# Helper Apps
	dobin ${NV_EXEC}/nvidia-xconfig ${NV_EXEC}/nvidia-bug-report.sh || die
	# Adding nvidia-smi per Gentoo bug #281893
